...
import ChartRnalphaPlusMinusPluginExpend from '@superset-ui/plugin-chart-rnalpha-plus-minus-expend';
  ...
  constructor() {
    ...
    super({
      ...
      plugins: [
        ...
        new ChartRnalphaPlusMinusPluginExpend().configure({ key: 'plugin-chart-rnalpha-plus-minus-expend', }),
