...
export default class EchartsRnkinWaterfallMetricsChartPlugin extends ChartPlugin<
  ...
  constructor() {
    super({
      ...
      metadata: new ChartMetadata({
        ...
        description: t(
          `A RnkinWaterfallMetrics chart is a form of data visualization that helps in understanding
        ...
        name: t('RnkinWaterfallMetrics Chart'),
