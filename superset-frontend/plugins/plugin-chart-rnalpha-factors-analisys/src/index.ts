...
import thumbnail from './images/factors.png';
import example1 from './images/factors.png';
...
const metadata = new ChartMetadata({
  ...
  description: t(
    'Таблица для описания и комментариев по факторному анализу',
  ),
  exampleGallery: [{ url: example1 }],
  name: t('Факторный анализ'),
  tags: [
  ],
  thumbnail,
});
